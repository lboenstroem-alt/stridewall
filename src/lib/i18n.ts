 ...
 */
/**
 * Trailing slashes are load-bearing: Astro emits directory-style pages, so the
 * host serves /vorgehen/ and 301s /vorgehen to it. Without the slash here the
 * canonical tag, the hreflang pair and every internal link would point at the
 * redirect rather than at the page the sitemap lists.
 */
